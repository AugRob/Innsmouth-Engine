        ...
        for(int i=0; i<  mpEntity->GetSubMeshEntityNum(); i++)
            {
                switch(mlRenderMode)
                    {
                    case 0:
                        RenderFlatSubMesh(mpEntity->GetSubMeshEntity(i));
                        break;
                    case 1:
                        RenderAlphaSubMesh(mpEntity->GetSubMeshEntity(i));
                        break;
                    case 2:
                        RenderSimpleCgSubMesh(mpEntity->GetSubMeshEntity(i), false);
                        break;
                    case 3:
                        RenderSimpleCgSubMesh(mpEntity->GetSubMeshEntity(i), true);
                        break;
                    case 4:
                        RenderLightingCgSubMesh(mpEntity->GetSubMeshEntity(i),false);
                        break;
                    case 5:
                        RenderLightingCgSubMesh(mpEntity->GetSubMeshEntity(i),true);
                        break;
                    }
            }
